  ...
  class Messages
    def initialize(commands)
      ...
      @messages = {
        ...
        book:        "Ваша книга: {{}}",
        not_found_with: "К сожалению, книга с категорией {{}} не найдена :(\n"\
                        "Воспользуйтесь поиском снова",

        not_found:   "К сожалению, книга не найдена :(\n"\
                     "Воспользуйтесь поиском снова, для помощи наберите #{@commands[:help]}",
